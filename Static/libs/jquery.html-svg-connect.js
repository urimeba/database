...
function addArrow($ = jQuery, window, document, undefined) {
  ...
  $.extend(Plugin.prototype, {
    ...
    connectElements: function (pathData) {
      ...
      if (orientation == "vertical") {
        ...
        centreSX = 1;
        centreSY = 0.5 + increase;
        centreEX = 0;
        centreEY = 0.5 + increase;
        increase++
      }
      // } else { // Added manual
      //   // centreSX = 1;
      //   // centreSY = 20;
      //   // centreEX = 0.3 + increase;
      //   // increase += 0.05
      // }
      // Calculate the path's start/end coordinates.
      // We want to align with the elements' mid point.
      startX = startCoord.left + centreSX * $startElem.outerWidth() - svgLeft;
      startY = startCoord.top + centreSY * $startElem.outerHeight() - svgTop;
      endX = endCoord.left + centreEX * $endElem.outerWidth() - svgLeft;
      endY = endCoord.top + centreEY * $endElem.outerHeight() - svgTop;
...
; (function ($, window, document, undefined) {
  ...
  addArrow($, window, document, undefined)
